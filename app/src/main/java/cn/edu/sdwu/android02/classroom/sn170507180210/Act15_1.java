...
public class Act15_1 extends AppCompatActivity {
    private ContentResolver contentResolver;
    private static final String CONTENT_URI_STRING="content://com.inspur.android2/student";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout15_1);
    ...
    public void query(View view){
        ...
        while (cursor.moveToNext()){
            Log.i(Act15_1.class.toString(),cursor.getString(cursor.getColumnIndex("stuname"))+cursor.getInt(cursor.getColumnIndex("id")));
        }
        cursor.close();
    }
