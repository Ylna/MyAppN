...
public class MyContentProvider extends ContentProvider {
    ...
    private static final String MIME_MAINTYPE_ITME="vnd.android.cursor.item";
    private static final String AUTHORITY="com.inspur.android2";
    ...
    static {
        uriMatcher= new UriMatcher(UriMatcher.NO_MATCH);//参数代表当前的匹配器无法匹配时烦的返回值  整型
        uriMatcher.addURI(AUTHORITY,"student",MULTIPLE_STUDENT);/* content://com.inspur.android2/student */
        uriMatcher.addURI(AUTHORITY,"student/#",SINGLE_STUDENT);/* content://com.inspur.android2/student/1 */
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (code){
            ...
            case SINGLE_STUDENT:
                return MIME_MAINTYPE_ITME+"/student";
        }
        // at the given URI.
